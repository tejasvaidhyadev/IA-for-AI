...
print("Dataset size of train and test:", len(train_wav_list))
...
for i in range(0, len(test_data)):
    cur_label = str(i%7)#'1'#'disgust' # label_map[test_data[i][1]]
    cur_path = './data/dataset/TestAudioFiles/' + test_data[i]
