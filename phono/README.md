...
This repository consists of models, scripts that help you to use all the benefits of Wav2Vec 2.0. In the following
...
python3 run_wav2vec_clf.py \
    --pooling_mode="mean" \
    --model_name_or_path="facebook/hubert-xlarge-ls960-ft" \
...
## Reference
- https://github.com/m3hrdadfi/soxan/tree/main
